...
return array(
    ...
    "The input is not a valid email address. Use the basic format local-part@hostname" => "Adres nie jest poprawnym adresem email w formacie nazwa@serwer",
    "'%hostname%' is not a valid hostname for email address '%value%'" => "Email '%value%' zawiera niepoprawną nazwę serwera '%hostname%'",
    "'%hostname%' is not a valid hostname for the email address" => "Email '%value%' zawiera niepoprawną nazwę serwera '%hostname%'",
    ...
    "Invalid type given. String expected" => "Podana wartość nie jest ciągiem znaków",
    "The input appears to be an IP address, but IP addresses are not allowed" => "Wartość '%value%' jest adresem IP a nie nazwą hosta",
    "The input appears to be a DNS hostname but cannot match TLD against known list" => "'%value%' zawiera nieznane TLD",
    "The input appears to be a DNS hostname but contains a dash in an invalid position" => "Nazwa hosta '%value%' zawiera znak '-' w złym miejscu",
    "The input appears to be a DNS hostname but cannot match against hostname schema for TLD '%tld%'" => "Nazwa hosta '%value%' jest niezgodna ze schematem dla TLD '%tld%'",
    "The input appears to be a DNS hostname but cannot extract TLD part" => "Nie można rozpoznać TLD dla nazwy hosta '%value%'",
    "The input does not match the expected structure for a DNS hostname" => "'%value%' nie jest poprawną nazwą hosta",
    "The input does not appear to be a valid local network name" => "'%value%' nie jest poprawną nazwą sieci lokalnej",
    "The input appears to be a local network name but local network names are not allowed" => "'%value%' prawdopodobnie jest nazwą sieci lokalnej. Nazwy sieci lokalnych są niedozwolone",
    "The input appears to be a DNS hostname but the given punycode notation cannot be decoded" => "Nie można zdekodować punycode dla podanej nazwy hosta '%value%'",
    ...
    "The input is less than %min% characters long" => "Pole zawiera mniej niż %min% znaków",
    "The input is more than %max% characters long" => "Pole zawiera więcej niż %max% znaków",
);
